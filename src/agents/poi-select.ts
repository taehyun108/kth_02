...
const ICONIC_RE = new RegExp(
  [
    ...
    "rossio", "호시우", "bairro\\s*alto", "chiado", "시아두", "sintra", "신트라", "pena\\s*palace|palácio\\s*da\\s*pena", "페나\\s*궁", "cabo\\s*da\\s*roca", "호카\\s*곶", "time\\s*out\\s*market", "mosteiro\\s*da\\s*batalha",
    // 영국/런던
